...
def train_equ3(generator, x, label, learning_rate, weight_decay, enable_at, lambda1, lambda2, batch_size, k=12, n_class=20, post_alpha=8, ro=0.04):
    # 这里使用的是Adam优化算法
    optimizer = torch.optim.Adam(generator.parameters(),
                                 lr=learning_rate,
                                 weight_decay=weight_decay)
